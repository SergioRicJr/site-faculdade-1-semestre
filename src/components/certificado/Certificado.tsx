...
const Certificado = ({svgIcon, titulo, link, listaConteudos, cargaHoraria}: any) => {
  ...
  return (
      <div className='certificado' style={{width: estadoAberto?"220px":"84px"}} onClick={()=> estadoAberto?null:setEstadoAberto(true)}>
        <div className="certificadoEsquerda" style={{width:estadoAberto?"176px":"0px", padding: estadoAberto?"5px":"0px"}}>
          <div className="cimaCertificado">
            ...
            <h2 className='tituloCertificado' style={{height: estadoAberto?"":"87px",width: estadoAberto?"206px":"170px",fontSize: estadoAberto?"16px":"14px",right: estadoAberto?"":"-47px",top: estadoAberto?"60px":"45px", transform: estadoAberto?"":"rotate(-90deg)"}}>{titulo}</h2>
          </div>
          {estadoAberto?(
              ...
              <a className="containerLink" target='_blank' href={link}>
